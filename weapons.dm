...
/obj/item/mecha_parts/mecha_equipment/weapon/ballistic/gatlinggun
	name = "\improper Inbuilt Gatling Gun"
	icon_state = "mecha_gatlingun"
	equip_cooldown = 10
	projectile = /obj/item/projectile/bullet/rifle/a12_7
	fire_sound = 'sound/weapons/gunshot/minigun2.ogg'
	projectiles = 2000
	projectiles_per_shot = 3
	deviation = 0.5
	projectile_energy_cost = 30 KILOWATTS
	fire_cooldown = 2
...
/obj/item/mecha_parts/mecha_equipment/weapon/ballistic/missile_rack/minimissiles
	name = "\improper Mini missile pod"
	icon_state = "mecha_minimissile"
...
/obj/item/mecha_parts/mecha_equipment/weapon/ballistic/missile_rack/minimissiles/Fire(atom/movable/AM, atom/target)
